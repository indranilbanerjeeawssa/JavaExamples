...
//		when(handler.ddbUpdater.insertIntoDynamoDB(ArgumentMatchers.any(ActiveMQEvent.ActiveMQMessage.class), ArgumentMatchers.any(Gson.class), ArgumentMatchers.any(LambdaLogger.class))).thenReturn(putItemOutcome);
